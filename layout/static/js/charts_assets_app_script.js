...
var Dashboard = {
    ...
    addWidget: function () {
        ...
        $('<div title="Add Widget" id="dialog_add_widget" style="overflow:hidden"><iframe src="/static/charts/shopify/addwidget.html" style="border:0px;width:100%;height:98%;" frameborder="0"></iframe></div>').dialog({
            resizable: true,
            width: 412,
            height: 375,
            modal: true,
    ...
    configureWidget: function (dwid) {
        ...
        $('<div title="Configure Widget" id="dialog_configure_widget" style="overflow:hidden"><iframe src="/static/charts/originals/config.html" style="border:0px;width:100%;height:98%;" frameborder="0"></iframe></div>').dialog({
            resizable: false,
            width: 550,
            modal: true,
            buttons: {
